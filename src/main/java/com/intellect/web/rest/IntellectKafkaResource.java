...
@RestController
@RequestMapping("/api/intellect-kafka")
public class IntellectKafkaResource {
    private final Logger log = LoggerFactory.getLogger(IntellectKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IntellectKafkaResource(KafkaProperties kafkaProperties) {
